...
/// A mixin to provide helper methods for interacting with Hive database.
///
/// This mixin provides methods to store, retrieve, save, update, delete, and fetch data from Hive boxes.
/// It also includes a method to vacuum the boxes for optimizing storage.
mixin HiveDBHelper {
