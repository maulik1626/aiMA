...
class SVGAssetsPath {
  ...
  static const String _scaffoldEllipseLayer = '${_path}scaffold_layer/landing_ellipse$_extension';
  ...
  // App Logo
  static const String _aunCabsLogo = '${_path}app_logo/aun_cabs_logo$_extension';
  ...
  static const String _icArrowRightDouble = '${_path}icons/ic_arrow_right_double$_extension';
  static const String _icBackButtonArrow = '${_path}icons/ic_back_button_arrow$_extension';
  ...
  static const String _icExclamation = '${_path}icons/ic_exclamation$_extension';
  static const String _icPersonOutlined = '${_path}icons/ic_person_outlined$_extension';
  static const String _icCloseSquareOutlined = '${_path}icons/ic_close_square_outlined$_extension';
  static const String _icArrowRight2 = '${_path}icons/ic_arrow_right_2$_extension';
  static const String _icDividerVert = '${_path}icons/ic_divider_vert$_extension';
  static const String _icNotificationOutlined = '${_path}icons/ic_notification_outlined$_extension';
  static const String _icLogout2 = '${_path}icons/ic_logout_2$_extension';
  static const String _icProfileOutlined = '${_path}icons/ic_profile_outlined$_extension';
  static const String _icCircleLock = '${_path}icons/ic_circle_lock$_extension';
  static const String _icEmailOutlined = '${_path}icons/ic_email_outlined$_extension';
  static const String _icHome = '${_path}icons/ic_home$_extension';
  static const String _icHomeFilledBlue = '${_path}icons/ic_home_filled_blue$_extension';
  static const String _icHomeFilledPurple = '${_path}icons/ic_home_filled_purple$_extension';
  static const String _icHomeFilledBrown = '${_path}icons/ic_home_filled_brown$_extension';
  ...
  static const String _icPetHomeSpa = '${_path}icons/ic_pet_home_spa$_extension';
  ...
  static const String _icCalendarTick = '${_path}icons/ic_calendar_tick$_extension';
  ...
  static const String _icCalendarCompleted = '${_path}icons/ic_calendar_completed$_extension';
  static const String _icCalendarRemove = '${_path}icons/ic_calendar_remove$_extension';
  static const String _icCalendarReschedule = '${_path}icons/ic_calendar_reschedule$_extension';
  ...
  static const String _icCreditCard2 = '${_path}icons/ic_credit_card_2$_extension';
  ...
  static const String _icAddSquareOutlined = '${_path}icons/ic_add_square_outlined$_extension';
  ...
  static const String _icCheckmarkSquare = '${_path}icons/ic_checkmark_square$_extension';
  static const String _icImageDelete = '${_path}icons/ic_image_delete$_extension';
  static const String _icSettings = '${_path}icons/ic_setting$_extension';
  static const String _icDocumentText = '${_path}icons/ic_document_text$_extension';
  static const String _icDocumentUpload = '${_path}icons/ic_document_upload$_extension';
  ...
  static const String _icDiscountBadge = '${_path}icons/ic_discount_badge$_extension';
  ...
  static const String _icDiscountFilled = '${_path}icons/ic_discount_filled$_extension';
  static const String _icCurrentLocation = '${_path}icons/ic_current_location$_extension';
  ...
  static const String _icCheckboxFilled = '${_path}icons/ic_checkbox_filled$_extension';
  static const String _icCheckboxFilledBrown = '${_path}icons/ic_checkbox_filled_brown$_extension';
  static const String _icCheckboxOutlined = '${_path}icons/ic_checkbox_outlined$_extension';
  static const String _icLocationDenied = '${_path}icons/ic_location_denied$_extension';
  static const String _icAddLocation = '${_path}icons/ic_add_location$_extension';
  static const String _icLocationDisabled = '${_path}icons/ic_location_disabled$_extension';
  static const String _icContactBook = '${_path}icons/ic_contact_book$_extension';
  static const String _icGreenCheckmarkBadge = '${_path}icons/ic_green_checkmark_badge$_extension';
  static const String _icAward1 = '${_path}icons/ic_award_1$_extension';
  static const String _icCheckmarkBadge = '${_path}icons/ic_checkmark_badge$_extension';
  static const String _icPeopleBadge = '${_path}icons/ic_people_badge$_extension';
  ...
  static const String _icTitleHighlight = '${_path}icons/ic_title_highlight$_extension';
  static const String _icContainerTag = '${_path}icons/ic_container_tag$_extension';
  static const String _icShare = '${_path}icons/ic_share$_extension';
  static const String _icCustomerSupport = '${_path}icons/ic_customer_support$_extension';
  ...
  static const String _icThumbsDownFilled = '${_path}icons/ic_thumbs_down_filled$_extension';
  static const String _icThumbsUpFilled = '${_path}icons/ic_thumbs_up_filled$_extension';
  static const String _icPaymentFailed = '${_path}icons/ic_payment_failed$_extension';
  static const String _icMoreH = '${_path}icons/ic_more_h_raw$_extension';
  static const String _icMicrophoneDisabled = '${_path}icons/ic_microphone_disabled$_extension';
  static const String _icMicrophoneEnabled = '${_path}icons/ic_microphone_enabled$_extension';
  static const String _icSpeakerDisabled = '${_path}icons/ic_speaker_disabled$_extension';
  static const String _icSpeakerEnabled = '${_path}icons/ic_speaker_enabled$_extension';
  static const String _icVideoDisabled = '${_path}icons/ic_video_disabled$_extension';
  static const String _icVideoEnabled = '${_path}icons/ic_video_enabled$_extension';
  ...
  static const String _icBookmarkFilled = '${_path}icons/ic_bookmark_filled$_extension';
  static const String _icBookmarkOutlined = '${_path}icons/ic_bookmark_outlined$_extension';
  static const String _icMaps = '${_path}icons/ic_maps$_extension';
  static const String _icCallCalling = '${_path}icons/ic_call_calling$_extension';
  static const String _icCheckmarkCircleFilled = '${_path}icons/ic_checkmark_circle_filled$_extension';
  static const String _icHeart = '${_path}icons/ic_heart$_extension';
  static const String _icHeartFilled = '${_path}icons/ic_heart_filled$_extension';
  static const String _icOutOfStock = '${_path}icons/ic_out_of_stock$_extension';
  static const String _icScooter = '${_path}icons/ic_scooter$_extension';
  static const String _icDeliveryBox = '${_path}icons/ic_delivery_box$_extension';
  static const String _icLoyaltyCard = '${_path}icons/ic_loyalty_card$_extension';
  static const String _icSavedItems = '${_path}icons/ic_saved_items$_extension';
  static const String _icPeopleAlsoBought = '${_path}icons/ic_people_also_bought$_extension';
  ...
  static const String _icOutForDelivery = '${_path}icons/ic_out_for_delivery$_extension';
  static const String _icDeliveryFailed = '${_path}icons/ic_delivery_failed$_extension';
  static const String _icDeliveryRescheduled = '${_path}icons/ic_delivery_rescheduled$_extension';
  static const String _icDelivered = '${_path}icons/ic_delivered$_extension';
  static const String _icOrderCanceled = '${_path}icons/ic_order_canceled$_extension';
  static const String _icReturnRequested = '${_path}icons/ic_return_requested$_extension';
  static const String _icReturnApproved = '${_path}icons/ic_return_approved$_extension';
  static const String _icReturnRejected = '${_path}icons/ic_return_rejected$_extension';
  static const String _icReturnPickupScheduled = '${_path}icons/ic_return_pickup_scheduled$_extension';
  static const String _icReturnPickedUp = '${_path}icons/ic_return_picked_up$_extension';
  static const String _icReturnReceived = '${_path}icons/ic_return_received$_extension';
  static const String _icReturned = '${_path}icons/ic_returned$_extension';
  static const String _icReplacementRequested = '${_path}icons/ic_replacement_requested$_extension';
  static const String _icReplacementCompleted = '${_path}icons/ic_replacement_completed$_extension';
...
class PNGAssetsPath {
  ...
  // Splash & Onboarding
  static const String _splash = '${_path}onboarding/splash$_extension';
...
class LOTTIEAssetsPath {
  ...
  static const String _doubleArrowRight = '${_path}lottie_double_arrow_right$_extension';
  static const String _confirmation = '${_path}lottie_confirmation$_extension';
  static const String _statusCancelled = '${_path}lottie_status_cancelled$_extension';
  static const String _statusPending = '${_path}lottie_status_pending$_extension';
  static const String _statusRescheduled = '${_path}lottie_status_rescheduled$_extension';
...
class AudioAssetsPath {
  ...
  // Audio
  static const String _bookingConfirmedSound = '${_path}booking_confirmed_sound$_extension';
...
class GifAssetsPath {
  ...
  static const String _confirmedDarkBrown = '${_path}confirmed_dark_brown$_extension';
  static const String _confirmedDarkPurple = '${_path}confirmed_dark_purple$_extension';
...
class HTMLAssetsPath {
  ...
  static const String _termsAndConditionsHtml = '${_path}terms_and_conditions.html';
